	...
	\section{UML Diagrams}\label{sec:uml-diagrams}
		...
		\subsection{Navigation Module}\label{subsec:uml-diagrams-notifications}
			...
			\subsubsection{Sequence Diagram}\label{subsec:uml-diagrams-notifications-seq}
				\begin{figure}[h!]
					\includegraphics[width=40em]{{"../Navigation subsystem/navigation sequence diagram"}.png}
					\label{fig: Users State Diagram}
                		\end{figure}		
            		\clearpage		
			...
			\subsubsection{State Diagram}\label{subsec:uml-diagrams-notifications-state}
				\begin{figure}[h!]
					\includegraphics[width=40em]{{"../Navigation subsystem/State Diagram"}.png}
					\label{fig: Users State Diagram}
                		\end{figure}		
			\clearpage
			...
			\subsubsection{Use Case Diagram}\label{subsec:uml-diagrams-notifications-uc}
				\begin{figure}[h!]
					\includegraphics[width=40em]{{"../Navigation subsystem/Navigation Use Case Diagram"}.png}
					\label{fig: Users State Diagram}
                		\end{figure}		
			\clearpage
		...
		\subsection{Points of Interest Module}\label{subsec:uml-diagrams-poi}
			...
			\subsubsection{Class Diagram}\label{subsec:uml-diagrams-poi-class}
							\begin{figure}[h!]
					\includegraphics[width=\linewidth]{{"../Points of Interest subsystem/Point of Intrest Class Diagram"}.png}
					\label{fig: Users State Diagram}
                		\end{figure}	
			\clearpage
			...
			\subsubsection{State Diagram}\label{subsec:uml-diagrams-poi-state}
								\begin{figure}[h!]
					\includegraphics[width=\linewidth]{{"../Points of Interest subsystem/Point of Intrest State Diagram"}.png}
					\label{fig: Users State Diagram}
                		\end{figure}	
			...
			\subsubsection{Use Case Diagram}\label{subsec:uml-diagrams-poi-uc}
										\begin{figure}[h!]
					\includegraphics[width=45em]{{"../Points of Interest subsystem/Points of Interest Use Case Diagram"}.png}
					\label{fig: Users State Diagram}
                		\end{figure}	
		\clearpage
		...
		\subsection{User Management Module}\label{subsec:uml-diagrams-users}
			...
			\subsubsection{Class Diagram}\label{subsec:uml-diagrams-users-class}
				\begin{figure}[h!]
					\includegraphics[width=\linewidth]{{"../User Managment subsystem/User Management Class Diagram"}.png}
					\label{fig: Users Class Diagram}
                		\end{figure}
				\clearpage
			\subsubsection{Activity Diagrams}\label{subsec:uml-diagrams-users-act}
				\begin{figure}[h!]
					\includegraphics[width=\linewidth]{{"../User Managment subsystem/User Management Activity Diagram 1"}.png}
					\label{fig: Users Activity Diagram}
                		\end{figure}
				\clearpage
				
								\begin{figure}[h!]
					\includegraphics[width=\linewidth]{{"../User Managment subsystem/User Management Activity Diagram 2"}.png}
					\label{fig: Users Activity Diagram}
                		\end{figure}
			\clearpage
			...
			\subsubsection{Use Case Diagram}\label{subsec:uml-diagrams-users-uc}	
				\begin{figure}[h!]
					\includegraphics[width=45em]{{"../User Managment subsystem/UserManagementUseCaseDiagram"}.png}
